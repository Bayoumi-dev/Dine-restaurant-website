...
const ReservationSection: FC = () => {
   return (
      <section
         className="h-150 bg-booking bg-center bg-no-repeat bg-cover 
         mb-[33.375rem] md:mb-[27.125rem] xl:mb-80 relative">
         <div
            className="w-full max-w-8xl h-80 absolute top-full left-0 xl:before:absolute 
            xl:before:w-248 xl:before:h-80 xl:before:bg-secondary-shuttleGray 
         ...
         <div
            ...
            <div
               ...
               <div
                  ...
                  xl:after:bg-pattern-lines xl:after:-bottom-6 

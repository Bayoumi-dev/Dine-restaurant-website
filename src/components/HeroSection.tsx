...
const HeroSection: FC = () => {
   return (
      <section className="h-187 md:h-248 xl:h-205 bg-primary-codGray text-white relative overflow-hidden">
         <picture className="w-full h-56 md:h-[23.3125rem] xl:w-360 xl:h-205 absolute xl:right-0 parallax">
